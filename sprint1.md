...
4.As a student, I want to delete a task, so that I can remove completed or unnecessary tasks.
...
| 3 | Create Task API | POST /api/tasks endpoint with validation | Completed |
...
| 7 | Description Table Implementation | Added description section with support for detailed text and file/image attachments to improve task clarity and collaboration | Completed |
| 9 | Create Task UI Implementation | Designed and implemented the Create Task page with task title, description, category, priority, and form structure | Completed |
| 10 | Date Picker Integration | Integrated date input/calendar picker for selecting deadlines in the correct format (mm/dd/yyyy) | Completed |
| 11 | Responsive Layout for Create Task Page | Updated CreateTask.css using flex/grid and breakpoints to ensure proper display on mobile, tablet, and desktop screens | Completed |
| 12 | Button Alignment Fix | Adjusted CSS to properly align “Create Task” and “Reset/Cancel” buttons with equal spacing and height across screen sizes | Completed |
