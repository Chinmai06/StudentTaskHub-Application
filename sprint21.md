...
- Task search by keyword (case-insensitive, searches title and description)
- Filter tasks by priority, deadline range, created_by, claimed_by
- Sort by newest/oldest
- User existence validation when creating or claiming tasks
- Foreign key constraints between tasks and users tables
- Comprehensive unit tests (34 tests covering all handler functions)

### Integration

- CORS middleware enables frontend to call backend API
- Frontend React app connects to backend at <http://localhost:8080/api>
...
2. As a student, I want to log in to my account so that I can access the system.
3. As a student, I want to search for tasks by keyword so that I can find specific tasks quickly.
4. As a student, I want to filter tasks by priority, status, deadline range, and creator so that I can find relevant tasks.
